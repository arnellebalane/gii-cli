...
var help = '\ncommand-line version of yii framework\'s gii tool\n\n'
  ...
  + '      --parent-class, -p   set the parent class for the model\n'
  + '      --table-name, -t     set the corresponding database table\n'
  + '                             for the model\n'
  + '    [type = controller]\n'
  + '      --parent-class, -p   set the parent class for the controller\n\n'
