...
var generator = {
  ...
  'controller': function() {
    console.log('\n  creating controller at ' + path.relative(process.cwd(), generator.directory) + ' directory');
    ...
    var template = fs.readFileSync(helper.template('controller'), 'utf8');
    ...
    var file_path = path.join(generator.directory, options.class + 'Controller.php');
    fs.writeFileSync(file_path, template, 'utf8');
