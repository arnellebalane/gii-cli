...
exports.help = function() {
  var message = '\n  Description: Generate a Yii scaffold\n\n'
    + '  Usage:\n\n'
    + '      gii crud <resource> [<attributes>]\n\n'
    + '          <resource>      the name of the resource to generate the scaffold for\n\n'
    + '          <attributes>    list of attributes which will become the columns of the database table\n'
